...
function onMessage(evt){
	...
	var lat = map(chimeData.ln, -180, 180, 0, 1638); //width
	var lon =map(chimeData.lt, 90, -90, 0, 819); // height
...
var worldMap;//this holds the map which is currently sized 1638 x 819
							//map for netchimes.com is 
var droplets = []; //an array of droplets (dynamic)


function setup() {
	window.resizeTo(1638, 819);
	var theCanvas = createCanvas(1638, 819); //we set the canvas size, rather the size of the active space
