...
int sensorLat = 0; //your latitude to 6 significant digits the Y value or width
int sensorLon = 0; //your longitude to 6 significnat digits the X value or height
